...
public class AssignedAssetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private boolean isLoading;
    private Activity activity;
    private List<AssignedFixAsset> mEvents;
    ...
    public AssignedAssetAdapter(Activity activity, List<AssignedFixAsset> mEvents, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder,int position) {
        if (holder instanceof FixAssetHolder) {
            ...
            AssignedFixAsset project = mEvents.get(userViewHolder.getAdapterPosition());
            ...
            Glide.with(activity).setDefaultRequestOptions(requestOptions).load(project.getAssetUrl()).into(userViewHolder.assetImage);
            userViewHolder.description.setText(project.getDescription());
            userViewHolder.action.setVisibility(View.VISIBLE);
